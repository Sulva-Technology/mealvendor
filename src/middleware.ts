...
export function middleware(request: NextRequest) {
  ...
  // If user is not logged in and not on the login page or Auth callback
  if (!hasToken && !request.nextUrl.pathname.startsWith('/login') && !request.nextUrl.pathname.startsWith('/auth')) {
